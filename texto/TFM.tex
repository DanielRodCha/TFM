...
\begin{titlepage}
 \vspace*{2cm}
  \begin{center}
     %{\huge \textbf{Una aproximación algebraica\\al problema SAT y su \\ \vspace{0.4cm} implementación funcional}}    
    {\huge \textbf{Una aproximación algebraica al \\ problema SAT y su implementación \\ \vspace{0.4cm} funcional}}
  \end{center}
  \vspace{4cm}
  \begin{center}
  ...
  \end{center}
  \begin{center}
    {\large \textbf{Daniel Rodríguez Chavarría}}
  \end{center}
 ...
 \begin{flushright}
   ...
   \begin{minipage}{8.45cm}
      Este Trabajo Fin de Máster ha sido posible gracias a la labor de muchas personas a las que me gustaría transmitirles mi más sincero agradecimiento:\\
      
      A la culpable de mis sonrisas.\\
      
      A mis familiares y amigos, que permanecen a mi lado ante toda dificultad.\\
      
      A mis compañeros de desayuno, sin los que empezar el día sería mucho más difícil.\\
      
      A Mª José Hidalgo, que me escucha y ayuda siempre que lo necesito.
    \end{minipage}
 ...
 \pagestyle{fancy}
  ...
  \vspace{2cm}
  A logic-algebraic model for solving $SAT$ problem is presented. It is based on a new inference rule of algebro-geometric inspiration. Soundness and refutational completeness of the rule are proved. The exposition of the theory lays the foundation for the implementation in Haskell of an efficient tool that solves $SAT$ problem. An analysis and a proposal to improve the tool conclude the thesis.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\addcontentsline{toc}{chapter}{Índice alfabético de funciones}
\printindex
