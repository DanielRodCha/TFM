...
$$[K, \mathcal{L} \setminus \{ p_3, p_4 \}] \equiv \{ \top \} \nvDash G $$
 ...
 p_3$. Para saber si $K \vDash F$, hay que computar $[K, \mathcal{L} (F)] \equiv
 \partial_{p_3} [K]$ y luego probar que $ \partial_{p_3} [K] \cup \{ \neg F \}$
 es inconsistente (saturando dicho conjunto):
